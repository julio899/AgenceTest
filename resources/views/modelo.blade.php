      ...
      <footer class="footer">
        <div class="container-fluid">
          <nav class="float-left">
            <ul>
              <li>
                <a href="https://www.github.com/julio899">
                  Creative Tim
                </a>
              </li>
              <li>
                <a href="https://julio899.github.io/2019">
                  About Us
                </a>
              </li>
              <li>
                <a href="http://blog.github.com/julio899">
                  Blog
                </a>
              </li>
              <li>
                <a href="https://www.github.com/julio899/license">
                  Licenses
                </a>
              </li>
            </ul>
          ...
          <div class="copyright float-right">
            ...
            <a href="https://julio899.github.io/perfil" target="_blank">Julio Vinachi</a>
          </div>
        </div>
      </footer>
    </div>
